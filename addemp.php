                ...
                <div class="card-body">
                    ...
                    <form action="process/addempprocess.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                                     <input class="input--style-1" type="number" placeholder="Employee Code" name="emp_code" required="required">
                        </div>
                        ...
                        <div class="input-group">
                                     <input class="input--style-1" type="number" placeholder="Mobile Number" name="mob_no" required="required">
                        </div>
                        <div class="input-group">
                         ...
                         <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="designation" name="desgination" required="required">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="date" placeholder="Joining Date" name="joiningDate" required="required">
                        </div>
